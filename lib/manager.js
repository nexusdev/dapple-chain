...
var Compiler = require('ethereumjs-testrpc/lib/solidity_compiler.js');
...
Manager.prototype.initialize = function() {
  var self = this;
  console.log("Manager intitialize");

  this.initialized = false;
  // new Blockchain(this.options, (err, blockchain) => {
  //   console.log("Manager on Blockchain init");
  //   this.blockchain = blockchain;
  //   this.initialized = true;
  //   this.accounts = this.options.accounts;
  //   this.total_accounts = this.options.total_accounts || 10;
  // });
...
Manager.prototype.waitForInitialization = function(callback) {
  var self = this;
  console.log("DC manager waitForInitialization called");
  // console.log('omg', this.initialized);
...
Manager.prototype.eth_call = function(tx_data, callback) {
  this.blockchain.queueCall(tx_data, Array.prototype.slice.call(arguments).slice(-1)[0]);
};
...
Manager.prototype.web3_clientVersion = function(callback) {
  callback(null, "Dapple Chain/v" + pkg.version + "/ethereum-js")
};
